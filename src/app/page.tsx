...
import { ArrowLeft, BadgeCheck, CalendarCheck, Camera, Check, ChevronLeft, ClipboardCheck, Menu, Phone, Route, Sparkles, SunMedium } from "lucide-react";
      ...
      <section id="home" className="hero-sunrise relative overflow-hidden border-b border-[#e9e4d8]">
        ...
        <div className="container-shell relative grid min-h-[730px] items-center gap-12 py-10 lg:grid-cols-[.92fr_1.08fr] lg:py-16">
          <div className="animate-rise order-2 lg:order-1">
            ...
            <p className="body-copy mt-7 max-w-xl text-[1.06rem]">{text("hero.description", "در مرکز ترک اعتیاد طلوع خورشید، مسیر رهایی با شنیدن بدون قضاوت، حفظ حریم شخصی و برنامه‌ای متناسب با شرایط هر فرد آغاز می‌شود. از سال ۱۳۸۸ کنار خانواده‌ها و مراجعان هستیم.")}</p>
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div className="relative h-[410px] overflow-hidden rounded-[28px] rounded-tr-[92px] border-[7px] border-white shadow-[0_32px_80px_rgba(18,63,56,.18)] sm:h-[520px] lg:h-[610px]">
              <Image src="/images/clinic-lounge.png" alt="فضای آرام و روشن مرکز ترک اعتیاد طلوع خورشید" fill priority sizes="(max-width: 1024px) 100vw, 55vw" className="object-cover" />
              ...
              <div className="absolute inset-x-5 bottom-5 flex items-center gap-3 rounded-2xl border border-white/25 bg-[#0b382f]/75 p-4 text-white shadow-lg backdrop-blur-md sm:inset-x-auto sm:bottom-7 sm:left-7 sm:max-w-[285px]">
                ...
                <span><b className="block text-sm">فضایی امن و محترمانه</b><small className="mt-1 block text-white/65">شروع با یک گفت‌وگوی بدون قضاوت</small></span>
              </div>
            </div>
          </div>
        </div>
