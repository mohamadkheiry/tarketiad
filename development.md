...
| `UPLOAD_DIR` | خیر | مسیر فایل‌های رسانه؛ پیش‌فرض `./uploads` و در Docker برابر `/app/uploads` |
| `MAX_IMAGE_UPLOAD_MB` | خیر | سقف حجم تصویر؛ پیش‌فرض ۱۵ مگابایت |
| `MAX_VIDEO_UPLOAD_MB` | خیر | سقف حجم ویدیو؛ پیش‌فرض ۲۰۰ مگابایت |
...
- `MediaItem`: مشخصات فایل، نوع، دسته‌بندی، وضعیت انتشار و ثبت رضایت
...
- CRUD خدمات و FAQ
- بارگذاری تصویر و MP4/WebM، پیش‌نمایش، انتشار و حذف رسانه
- جلوگیری از انتشار روایت بهبودی بدون ثبت رضایت
...
- برای رسانه‌های بارگذاری‌شده، دسترسی نوشتن به `UPLOAD_DIR` و وجود فایل متناظر در Volume را بررسی کنید.
- فایل غیرفعال برای کاربر عمومی عمداً پاسخ 404 می‌دهد و فقط در نشست مدیر قابل پیش‌نمایش است.
